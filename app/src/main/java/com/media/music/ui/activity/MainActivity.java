...
import com.media.music.listener.PanelSlideListener;
import com.media.music.permission.PermissionCallback;
...
public class MainActivity extends BaseActivity implements ATEActivityThemeCustomizer, DrawerLayout.DrawerListener {
  ...
  private void checkPermissionAndThenLoad() {
    ...
    if (PermissionManager.checkPermission(Manifest.permission.READ_EXTERNAL_STORAGE)) {
      ...
      if (PermissionManager.shouldShowRequestPermissionRationale(this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
        Snackbar.make(panelLayout, "App will need to read external storage to display songs on your device.",
  ...
  public void onDrawerSlide(View drawerView, float slideOffset) {
    panelLayout.setX(slideOffset*drawerView.getWidth());
  }
