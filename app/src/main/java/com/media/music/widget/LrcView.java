...
import com.media.music.util.ScreenUtils;
...
public class LrcView extends View {
  ...
  private void init(AttributeSet attrs) {
    ...
    mTextSize = ta.getDimension(R.styleable.LrcView_lrcTextSize, ScreenUtils.sp2px(getContext(), 12));
    mDividerHeight = ta.getDimension(R.styleable.LrcView_lrcDividerHeight, ScreenUtils.dp2px(getContext(), 16));
    ...
    mLabel = TextUtils.isEmpty(mLabel) ? "No lyrics yet" : mLabel;
